...
@section('title', 'Terms & Policy Edit')
@section('backend_content')
    <div class="card mb-6">
        <div class="card-body">
            <form action="{{ route('terms-policy.update', $records->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                            ...
                            <div class="row row-cols-1 row-cols-md-1 g-6">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="terms_title" value="{{ $records->terms_title }}"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" cols="12"
                                            id="terms_editor">{{ $records->description }}</textarea>
