            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="hero-content" role="tabpanel">
                    <div class="container mt-4">
                        ...
                        <form action="{{ route('c-d-home-hero.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="expertiseWrapper">
                                        @if (!empty($value->expertise))
                                            @foreach (json_decode($value->expertise) as $expertise)
                                        ...
                                        @else
                                            <div class="d-flex mb-2">
                                                <input type="text" name="expertise[]" class="form-control me-2">
                                                <button type="button"
                                                    class="btn btn-danger btn-sm removeExpertise">X</button>
                                            </div>
                                        @endif
