@extends('layouts.app')
@section('title', 'Donation Policy')
@section('front_content')
    <!-- Banner area start here -->
    @php
        $donation = DB::table('about_pages')->where('is_display', 'donation_policy')->first();
    @endphp
    ...
    @php
        $faqs = DB::table('faqs')->where('display', 'donation-policy')->where('status', '1')->orderBy('id', 'asc')->get();
    @endphp
    @if ($faqs->isnotEmpty())
...
@endsection
 @php
        $record = DB::table('cta_buttons')->wherejsonContains('is_display', 'donation-policy')->where('status', '1')->first();
    @endphp
