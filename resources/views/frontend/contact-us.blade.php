...
@section('front_content')
    ...
    <section class="contact-area pb-120 d-none">
                            ...
                            <form action="{{ route('contact.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input id="number" name="phone" type="text" placeholder="Enter your phone number">
                                        <div class="form-text text-danger">{{ $errors->first('phone') }}</div>
                                    </div>
                                </div>
            
                                <label for="subject_name">Subject</label>
                                <input id="subject_name" name="subject_name" type="text" placeholder="Enter your Subject here">
